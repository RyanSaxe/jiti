...
- submit(impl, tests, quality): validate a candidate (ruff + ty + your tests, run in-process) and report your honest 0-10 quality rating. Iterate until it returns PASSED, then stop.
